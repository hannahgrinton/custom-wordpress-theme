<?php
/**
 * hannahgrinton-theme functions and definitions
 *
...
if ( ! function_exists( 'hannahgrinton_theme_setup' ) ) :
	/**
	 ...
	 */
	function hannahgrinton_theme_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on hannahgrinton-theme, use a find and replace
		 * to change 'hannahgrinton-theme' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'hannahgrinton-theme', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'hannahgrinton_theme_custom_background_args', array(
...
add_action( 'after_setup_theme', 'hannahgrinton_theme_setup' );
 ...
 */
function hannahgrinton_theme_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'hannahgrinton_theme_content_width', 640 );
}
add_action( 'after_setup_theme', 'hannahgrinton_theme_content_width', 0 );
 ...
 */
function hannahgrinton_theme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'hannahgrinton-theme' ),
		'id'            => 'sidebar-1',
...
function hannahgrinton_theme_scripts() {
	...
	wp_enqueue_script( 'hannahgrinton-theme-templates', get_template_directory_uri() . '/js/templates.js', array('jquery'), '20151215', true );
...
add_action( 'wp_enqueue_scripts', 'hannahgrinton_theme_scripts' );
